...
import isaac_sellam_epicurien_wax_pants_stone_white_4 from './assets/men/isaac sellam/isaac sellam epicurien-wax pants/stone white/4.jpg';
...
import carson_black_4 from './assets/men/the last conspiracy/carson/black/4.jpg';
...
import riley_black_3 from './assets/men/the last conspiracy/riley/black/3.jpg';
import riley_black_4 from './assets/men/the last conspiracy/riley/black/4.jpg';
...
import dce_jacket_black_4 from './assets/women/139dec/139dec jacket/black/4.jpg';

import coat_black_1 from './assets/women/avant toi/coat/black/1.jpg';
import coat_black_2 from './assets/women/avant toi/coat/black/2.jpg';
import coat_black_3 from './assets/women/avant toi/coat/black/3.jpg';
import coat_black_4 from './assets/women/avant toi/coat/black/4.jpg';

import rta_stella_black_1 from './assets/women/rta/rta stella/black/1.jpg';
import rta_stella_black_2 from './assets/women/rta/rta stella/black/2.jpg';
import rta_stella_black_3 from './assets/women/rta/rta stella/black/3.jpg';
import rta_stella_black_4 from './assets/women/rta/rta stella/black/4.jpg';

import trasint_leather_jacket_brown_1 from './assets/women/trasint/trasint leather jacket/brown/1.jpg';
import trasint_leather_jacket_brown_2 from './assets/women/trasint/trasint leather jacket/brown/2.jpg';
import trasint_leather_jacket_brown_3 from './assets/women/trasint/trasint leather jacket/brown/3.jpg';
import trasint_leather_jacket_brown_4 from './assets/women/trasint/trasint leather jacket/brown/4.jpg';

import y3_adilette_white_1 from './assets/women/y-3/y-3 adilette slide sandals/white/1.jpg';
import y3_adilette_white_2 from './assets/women/y-3/y-3 adilette slide sandals/white/2.jpg';
import y3_adilette_white_3 from './assets/women/y-3/y-3 adilette slide sandals/white/3.jpg';
import y3_adilette_white_4 from './assets/women/y-3/y-3 adilette slide sandals/white/4.jpg';
...
export const designers = {
  men: [
    { order: '#', designer: ['10SEI0OTTO'] },
    { order: '1', designer: ['11 BY BORIS BIDJAN SABERI', '139DCE'] },
    { order: '5', designer: ['50 60 OFF'] },
    {
      order: 'a',
      designer: ['AITO', 'ANDREA ZORI', 'ANN DEMEULEMEESTER', 'AVANT TOI'],
    },
    { order: 'b', designer: ['BAZZ&LUTRA', 'BLK DNM', 'BORIS BIDJAN SABERI'] },
    { order: 'c', designer: ['CROQUIS BY JNBY'] },
    { order: 'd', designer: ['D.HYGEN', 'DAMIR DOMA', 'DANIELE BASTA'] },
    { order: 'e', designer: ['ENRI MARS'] },
    { order: 'f', designer: ['FAGASSENT'] },
    {
      order: 'g',
      designer: [
    ...
    { order: 'h', designer: ['H BY HUDSON'] },
    { order: 'i', designer: ['INCARNATION', 'ISAAC SELLAM'] },
  ],
  women: [{ order: '#', designer: ['10SEI0OTTO', 'tyzfdgf', '"é&"(-'] }],
};
