...
export const designers = {
  men: [
    {
      order: '#',
      designer: [{ desig: '10SEI0OTTO', desc: '' }],
      id: uuidv4(),
    },
    {
      order: '1',
      designer: [
        { desig: '11 BY BORIS BIDJAN SABERI', desc: '' },
        { desig: '139DCE', desc: '' },
      ],
      id: uuidv4(),
    },
    ...
    },
    {
      ...
      designer: [
        { desig: 'AITO', desc: '' },
        { desig: 'ANDREA ZORI', desc: '' },
        { desig: 'ANN DEMEULEMEESTER', desc: '' },
        { desig: 'AVANT TOI', desc: '' },
      ],
      id: uuidv4(),
    },
    {
      order: 'b',
      designer: [
        { desig: 'BAZZ&LUTRA', desc: '' },
        { desig: 'BLK DNM', desc: '' },
        { desig: 'BORIS BIDJAN SABERI', desc: '' },
      ],
      id: uuidv4(),
    },
    {
      order: 'c',
      designer: [{ desig: 'CROQUIS BY JNBY', desc: '' }],
      id: uuidv4(),
    },
    {
      order: 'd',
      designer: [
        { desig: 'D.HYGEN', desc: '' },
        { desig: 'DAMIR DOMA', desc: '' },
        { desig: 'DANIELE BASTA', desc: '' },
      ],
      id: uuidv4(),
    },
    {
      order: 'e',
      designer: [{ desig: 'ENRI MARS', desc: '' }],
      id: uuidv4(),
    },
    {
      order: 'f',
      designer: [{ desig: 'FAGASSENT', desc: '' }],
      id: uuidv4(),
    },
    {
      order: 'g',
      designer: [
        { desig: 'GENE PAR YUKIO MISHIBA', desc: '' },
        { desig: 'GIL ZOHAR', desc: '' },
        { desig: 'GIORGIO BRATO', desc: '' },
        { desig: 'GOTI', desc: '' },
        { desig: 'GUIDI', desc: '' },
        { desig: 'GUNDA', desc: '' },
      ],
